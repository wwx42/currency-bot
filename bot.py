...
def list_crypto(update: Update, context: CallbackContext):
    ...
    context.bot.send_chat_action(chat_id, ChatAction.TYPING)
    update.message.reply_text(
        text="Ten of the best Crypto currencies with ISO code:\n\n1. [Bitocin](https://bitcoin.org) --------------> /getprice BTC\n1. [Bitocin](https://bitcoin.org) --------------> /getchart BTC\n\n2. [Ethereum](https://www.ethereum.org) -------------> /getprice ETH\n2. [Ethereum](https://www.ethereum.org) -------------> /getchart ETH\n\n3. [Tether](https://tether.to) ----------------------> /getprice USDT\n3. [Tether](https://tether.to) ----------------------> /getchart USDT\n\n4. [Binance](https://www.binance.com) -------------------------> /getprice BNB\n4. [Binance](https://www.binance.com) -------------------------> /getchart BNB\n\n5. [Solona](https://solana.com/) -------------------------------> /getprice  SOL\n5. [Solona](https://solana.com/) -------------------------------> /getchart SOL\n\n6. [Doge Coin](https://dogecoin.com/) ---------------------> /getprice  DOGE\n6. [Doge Coin](https://dogecoin.com/) ---------------------> /getchart DOGE\n\n7. [Tron](https://tron.network) -----------------------------> /getprice TRX\n7. [Tron](https://tron.network) -----------------------------> /getchart TRX\n\n8. [Shiba Inu](https://shibatoken.com/) ------------------> /getprice SHIB\n8. [Shiba Inu](https://shibatoken.com/) ------------------> /getchart SHIB\n\n9. [Bitcon Cash](https://bch.info/) -----------> /getprice BCH\n9. [Bitcon Cash](https://bch.info/) -----------> /getchart BCH\n\n10. [Cardano](https://cardano.org/) ----------> /getprice ADA\n10. [Cardano](https://cardano.org/) ----------> /getchart ADA\n\nClick on the more button for more Crypto currencies ...",parse_mode='MarkdownV2',disable_web_page_preview=True,
...
def list_company(update: Update, context: CallbackContext):
    ...
    context.bot.send_chat_action(chat_id, ChatAction.TYPING)
    update.message.reply_text(
        text="Five of the best Companies with ISO code:\n\n1. [Apple](https://www.apple.com/) --------------> /getchart AAPL\n\n2. [Google](https://www.google.org/) ----------------------> /getchart GOOGL\n\n3. [Amazon](https://www.amazon.com/) -------------------------> /getchart AMZN\n\n4. [Tesla](https://www.tesla.com/) -----------------------> /getchart TSLA\n\n5. [Alibaba.com](https://www.alibaba.com/) --------> /getchart BABA\n\nClick on the more button for more Companies ...",parse_mode='MarkdownV2',disable_web_page_preview=True,
        reply_markup=InlineKeyboardMarkup(buttons)
    )
# ---------------------------> more button < ---------------------------
